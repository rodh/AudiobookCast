    ...
    for (const folder of groupFolders) {
      ...
      for (const item of items) {
        ...
        try {
          ...
          // Extract author/tags/year from first successful parse
          if (!metadataExtracted) {
            const common = metadata.common;
            if (common.artist) author = common.artist;
            if (common.genre && common.genre.length) tags = common.genre;
